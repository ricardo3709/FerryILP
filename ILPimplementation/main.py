...
if results:
    taskF_results, mu_results, xi_results, phi_results, E_results = results
...
# Add constraints
add_constraints(model, config, x, y, Q, z, Z, Z_prime, phi_results, E_results, mu_results, taskF_results, xi_results)
